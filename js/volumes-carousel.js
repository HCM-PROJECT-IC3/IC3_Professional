    ...
    const BOOKS = [
      {
        id: "spark-level-1",
        title: "IC3-GS6 SPARK LEVEL 1",
        roman: "I",
        discipline: "IC3 GS6 · SPARK",
        note: "Computing fundamentals for confident digital learners.",
        deck: "IC3 GS6 SPARK Level 1 — foundational digital literacy, computing fundamentals, key applications, online living, problem solving, computational thinking, and global standards.",
        binding: "Green illustrated cover · IC3 GS6 SPARK",
        format: "IC3 GS6 · Spark Level 1",
        theme: "Computing Fundamentals",
        motif: "IC3 GS6 SPARK Level 1",
        motifKey: "none",
        paletteLabel: "Green · white · illustrated",
        color: "#4f9f45",
        foil: "#ffffff",
        palette: {
          paper: "#f7f7f2",
        ...
        height: 1.58,
        depth: 0.26,
        chapters: ["Computing Fundamentals", "Key Applications", "Problem Solving"],
        seed: 101
      },
      {
        id: "spark-level-2",
        title: "IC3-GS6 SPARK LEVEL 2",
        roman: "II",
        discipline: "IC3 GS6 · SPARK",
        note: "Build stronger application and digital problem-solving skills.",
        deck: "IC3 GS6 SPARK Level 2 — a practical progression through digital tools, online living, problem solving, computational thinking, and global standards.",
        binding: "Teal illustrated cover · IC3 GS6 SPARK",
        format: "IC3 GS6 · Spark Level 2",
        theme: "Key Applications",
        motif: "IC3 GS6 SPARK Level 2",
        motifKey: "none",
        paletteLabel: "Teal · white · illustrated",
        color: "#229eaa",
        foil: "#ffffff",
        palette: {
          paper: "#f7f7f2",
        ...
        height: 1.58,
        depth: 0.26,
        chapters: ["Key Applications", "Online Living", "Computational Thinking"],
        seed: 102
      },
      {
        id: "spark-level-3",
        title: "IC3-GS6 SPARK LEVEL 3",
        roman: "III",
        discipline: "IC3 GS6 · SPARK",
        note: "Extend digital literacy into deeper practical challenges.",
        deck: "IC3 GS6 SPARK Level 3 — advanced learner practice across applications, online living, problem solving, computational thinking, and global standards.",
        binding: "Red illustrated cover · IC3 GS6 SPARK",
        format: "IC3 GS6 · Spark Level 3",
        theme: "Problem Solving",
        motif: "IC3 GS6 SPARK Level 3",
        motifKey: "none",
        paletteLabel: "Red · white · illustrated",
        color: "#c73535",
        foil: "#ffffff",
        palette: {
          paper: "#f7f7f2",
        ...
        height: 1.58,
        depth: 0.26,
        chapters: ["Problem Solving", "Computational Thinking", "Global Standards"],
        seed: 103
      },
      {
        id: "level-1",
        ...
        roman: "IV",
        discipline: "IC3 GS6 · STANDARD",
        note: "Core digital literacy and computing fundamentals.",
        deck: "IC3 GS6 Level 1 — foundational skills across computing fundamentals, key applications, online living, problem solving, computational thinking, and global standards.",
        binding: "Green standard cover · IC3 GS6",
        format: "IC3 GS6 · Level 1",
        theme: "Computing Fundamentals",
        motif: "IC3 GS6 Level 1",
        motifKey: "none",
        paletteLabel: "Green · white · standard",
        color: "#5a9f4d",
        foil: "#ffffff",
        palette: {
          paper: "#f7f7f2",
        ...
        height: 1.58,
        depth: 0.26,
        chapters: ["Computing Fundamentals", "Key Applications", "Online Living"],
        seed: 104
      },
      {
        id: "level-2",
        ...
        roman: "V",
        discipline: "IC3 GS6 · STANDARD",
        note: "Practical digital skills across applications and online work.",
        deck: "IC3 GS6 Level 2 — continued development of applications, online living, problem solving, computational thinking, and global standards.",
        binding: "Blue standard cover · IC3 GS6",
        format: "IC3 GS6 · Level 2",
        theme: "Key Applications",
        motif: "IC3 GS6 Level 2",
        motifKey: "none",
        paletteLabel: "Blue · white · standard",
        color: "#2f63a5",
        foil: "#ffffff",
        palette: {
          paper: "#f7f7f2",
        ...
        height: 1.58,
        depth: 0.26,
        chapters: ["Key Applications", "Digital Citizenship", "Problem Solving"],
        seed: 105
      },
      {
        id: "level-3",
        ...
        roman: "VI",
        discipline: "IC3 GS6 · STANDARD",
        note: "Advanced digital literacy, security, and global standards.",
        deck: "IC3 GS6 Level 3 — advanced practice in applications, online living, problem solving, computational thinking, and global standards.",
        binding: "Red standard cover · IC3 GS6",
        format: "IC3 GS6 · Level 3",
        theme: "Digital Citizenship",
        motif: "IC3 GS6 Level 3",
        motifKey: "none",
        paletteLabel: "Red · white · standard",
        color: "#b9343b",
        foil: "#ffffff",
        palette: {
          paper: "#f7f7f2",
        ...
        height: 1.58,
        depth: 0.26,
        chapters: ["Digital Citizenship", "Problem Solving", "Global Standards"],
        seed: 106
      }
    ]

    const COVER_ATLAS_DATA = "img/complete-shelf-preview.png";

    // Six real IC3-GS6 covers are cropped from the existing artwork in img/.
    // Coordinates are source pixels in complete-shelf-preview.png (1672 × 941).
    const COVER_CROPS = [
      [38, 315, 258, 396],
      [318, 315, 240, 396],
      [585, 315, 236, 396],
    ...
    function makeCoverTexture(book) {
      ...
      const crop = COVER_CROPS[BOOKS.indexOf(book)];
      if (coverAtlasReady && crop) {
      ...
      // Keep a safe visual fallback if the local image cannot be decoded.
      ...
      ctx.fillText(book.title, canvasTexture.width / 2, canvasTexture.height / 2);
      return configureCanvasTexture(new THREE.CanvasTexture(canvasTexture));
    }
    ...
    function createBookRig(book, index) {
      ...
      // The cover image already contains the complete official artwork.
      // Do not overlay the old procedurally-generated foil/motif layer.
      foilPlane.visible = false;
    ...
    function closeDetail() {
      ...
      // Move focus away BEFORE hiding/inerting the dialog. Otherwise the
      // focused #close-detail button becomes a descendant of an
      // aria-hidden ancestor and Edge/Chrome reports an accessibility warning.
